...
from app.models import Base # import Base from the models file (not database file) so that alembic has the opportunity to readup the models for the table you defined
